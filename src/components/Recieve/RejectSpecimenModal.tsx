    ...
    <div className="receive-modal-overlay" role="presentation" onClick={onClose}>
      ...
      >
        <div className="receive-modal-header">
          ...
          <button type="button" className="receive-modal-close" onClick={onClose} aria-label="Close reject specimen modal">
        ...
        <div className="receive-modal-actions">
          ...
          <button type="button" className="receive-modal-confirm" onClick={onConfirm}>Reject</button>
        </div>
      </div>
    </div>
  );
